...
Itt kéne majd unity specifikus modulok is / külön fejezetbe.
...
\begin{enumerate}
	...
	\begin{itemize}
		\item Az első mező a kártyák rangjának előfordulásáról tartalmaz 15~biten információt. Az egyes biteken azt fogjuk jelölni, hogy az adott rangból van-e az 5 adott kártya között (1 ha van, 0 ha nincs). \Aref{fig-bitfieldvalues1} ábrán és \aref{fig-bitfieldvalues2} ábrán látható 1-1 példa az elő állított bitmezőről.
		
		\begin{figure}[ht!]
			\centering
			\includegraphics[width=10cm]{BitFieldValues1}
			\caption{Kártyák: [9, 10, J, Q, K]}
			\label{fig-bitfieldvalues1}
		\end{figure}
		
		\begin{figure}[ht!]
			\centering
			\includegraphics[width=10cm]{BitFieldValues2}
			\caption{Kártyák: [9, 9, 9, K, K]}
			\label{fig-bitfieldvalues2}
		\end{figure}
		
		\item A második mező a rangok előfordulásának számáról tárol információt 60~biten. Minden ranghoz rendelünk 4 bitet, ahol annyit jelölünk 1-el, amennyi darabunk van az adott rangból. \Aref{fig-bitfieldcounts1} ábrán és \aref{fig-bitfieldcounts2} ábrán látható 1-1 példa az elő állított bitmezőről.
		
		\begin{figure}[ht!]
			\centering
			\includegraphics[width=16cm]{BitFieldCounts1}
			\caption{Kártyák: [9, 10, J, Q, K]}
			\label{fig-bitfieldcounts1}
		\end{figure}
		
		\begin{figure}[ht!]
			\centering
			\includegraphics[width=16cm]{BitFieldCounts2}
			\caption{Kártyák: [9, 9, 9, K, K]}
			\label{fig-bitfieldcounts2}
		\end{figure}
