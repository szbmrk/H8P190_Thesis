...
\ref{fig-clientserver}. ábra -- saját készítésű ábra, \cite{ResearchGateClientServer} alapján \dotfill
\newline
\ref{fig-p2p}. ábra -- saját készítésű ábra, \cite{TechTermsP2P} alapján \dotfill
\newline
\ref{fig-unityeditor}. ábra -- saját készítésű ábra \dotfill
\newline
\ref{fig-unityrelayservers}. ábra -- saját készítésű ábra, \cite{UnityRelayServers} alapján \dotfill
\newline
\ref{fig-pokerhands}. ábra -- \url{https://cardmates.co.uk/all_poker_hands} [Letöltve: 2025-03-02] \dotfill   
\newline
\ref{fig-lobby}. ábra -- saját készítésű ábra \dotfill
