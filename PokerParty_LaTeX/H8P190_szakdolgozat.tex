...
A szakdolgozatomban fejlesztek először többjátékos játékot, ami mindig is egy célom volt. A tapasztalataim és az egyetem segítségével már magabiztosan tudtam elkezdeni a fejlesztést és mint minden eddigi fejlesztésem során, most is sokat tudtam tanulni a folyamat alatt. A játékom ötletét és célját \aref{ch-rendszerterv}. fejezetben fejtem ki bővebben.
...
\begin{center}
	...
	{\color{teal}\url{https://github.com/szbmrk/H8P190_Thesis_Builds}}
...
A közös DLL szerepe azoknak a függvényeknek és metódusoknak összegyűjtése, amit mind a PC illetve a Mobil játék során is használok a kódban. Ennek egyik legfontosabb része a kézkiértékeléshez szükséges algoritmus, amiről bővebben \aref{subsec-kezkiertekeloalgoritmus}. szekcióban írok. A DLL-nek egy másik fontos része a két játék közötti üzenetek egységbe fogása. Az üzenetek küldéséről \aref{sec-tobbjatekoskapcsolat}. szekcióban bővebben írok, de a lényeg, hogy az üzenet küldés során használt osztályokat is a DLL tartalmazza, hiszen így mindkét oldal egységesen tudja kezelni őket.
...
Az osztó keveri és osztja ki a lapokat a szabályok szerint. A vakok pedig még osztás előtt kötelesek betenni a vak téteket, ahol a kis vak tét általában a nagy vak tét fele. Egy játszma az alábbiak szerint játszódhat le: \cite{TexasholdemSzabalyok} \cite{WikipediaTexasholdem}
...
A fejlesztés során a már \aref{subsec-prefab}. szekcióban is említettem hogy a Prefab-ek használata nagyon hasznos tud lenni a többször használatos játék elemek során. A játékban Prefab-et több helyen is használtam, viszont a legfontosabb a játékosokat megjelenítő UI elemek voltak. Ezzel a módszerrel minden játékosnak a megjelenítését egységes módon tudtam kezelni. Ilyen Prefab volt még pl. a hiba üzenetet megjelenítő felugró ablak, a chat üzeneteket megjelenítő chat doboz, a mobilon lévő lehetséges akciókat kezelő gombok és csúszkák és még hasonló UI elemek.
...
A playtest-ek során teszt jegyzőkönyvet is vezettem. A jegyzőkönyvek segítettek a hibák dokumentálásában, így később is egységes formában át tudtam nézni az észlelt hibákat. Egy ilyen jegyzőkönyv látható a főmenü jelentről \aref{tab-tesztjegyzokonyv}. táblázatban.
